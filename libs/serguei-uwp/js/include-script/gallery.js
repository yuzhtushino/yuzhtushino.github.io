  ...
  var run = function run() {
    ...
    var manageLightGallery = function manageLightGallery(macyGrid) {
      ...
      if (!scriptIsLoaded("../../cdn/lightgallery.js/1.1.1/js/lightgallery.fixed.js")) {
        var load;
        load = new loadJsCss(["../../cdn/lightgallery.js/1.1.1/css/lightgallery.fixed.css", "../../cdn/lightgallery.js/1.1.1/js/lightgallery.fixed.js", "../../cdn/lightgallery.js/1.1.1/js/lg-fullscreen.js", "../../cdn/lightgallery.js/1.1.1/js/lg-thumbnail.js", "../../cdn/lightgallery.js/1.1.1/js/lg-zoom.js"], initScript);
      } else {
        initScript();
      }
    };
