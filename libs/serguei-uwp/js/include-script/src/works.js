	...
	root.runWorks = function () {
		...
		var addMacyItems = function (macy, callback) {
			...
			for (i = 0, l = macyItems.length; i < l; i += 1) {
				html.push('<a href="' + macyItems[i].href + '" data-src="' + macyItems[i].href + '" class="iframe-lightbox-link ' + macyItemIsBindedClass + '" data-padding-bottom="56.25%" data-scrolling="true" aria-label="Ссылка"><img src="' + transparentPixel + '" class="' + dataSrcImgClass + '" data-src="' + macyItems[i].src + '" alt="" /></a>\n');
				count++;
